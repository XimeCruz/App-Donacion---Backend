...
(2, 9, 300, 'Calle Libertad 123', 'contacto@alberguepaz.com', '/images/a3.jpeg', -12.046374, -77.0427934, 'Albergue de la Paz', '26751234', 'Disfruta de la comodidad y la calidez de nuestras instalaciones, ideales para viajeros que buscan un lugar seguro y céntrico en la vibrante ciudad.');

INSERT INTO public.albergue (id, beneficiario_id, capacidad, direccion, email, imagen, latitud, longitud, nombre, telefono, descripcion) VALUES
(3, 10, 120, 'Av. Bolívar 908', 'reservas@casadelviajero.com', '/images/a4.jpeg', -13.531950, -71.967463, 'Casa del Viajero', '984567123', 'Una experiencia única en el corazón histórico, donde el confort y la historia se encuentran para ofrecerte una estancia inolvidable.');

INSERT INTO public.albergue (id, beneficiario_id, capacidad, direccion, email, imagen, latitud, longitud, nombre, telefono, descripcion) VALUES
(4, 12, 450, 'Calle Fortaleza 77', 'info@fortalezahostel.com', '/images/a5.jpeg', -34.603684, -58.381559, 'Fortaleza Hostel', '45127893', 'Ven a disfrutar de nuestro acogedor albergue, con espaciosas habitaciones y una atención amable que te hará sentir como en casa.');

INSERT INTO public.albergue (id, beneficiario_id, capacidad, direccion, email, imagen, latitud, longitud, nombre, telefono, descripcion) VALUES
(5, 13, 200, 'Paseo de los Turistas', 'albergueplaya@mar.com', '/images/a6.jpeg', -33.047238, -71.6126885, 'Albergue Playa Serena', '321654987', 'Ideal para los amantes del sol y la playa, nuestro albergue ofrece las mejores vistas al mar y actividades para disfrutar de la naturaleza.');

INSERT INTO public.albergue (id, beneficiario_id, capacidad, direccion, email, imagen, latitud, longitud, nombre, telefono, descripcion) VALUES
(6, 14, 350, 'Avenida de los Pioneros 456', 'pioneros@albergueaventura.com', '/images/a7.jpeg', -54.801912, -68.3029511, 'Albergue Aventura', '229876543', 'Explora la naturaleza salvaje y descansa en nuestro albergue, donde cada día es una aventura y el confort es nuestra promesa.');


INSERT INTO public.actividad (id, cantidad, fecha, nombre_producto) VALUES (1, 4, '2024-04-30 02:04:10.000000', 'A');
INSERT INTO public.actividad (id, cantidad, fecha, nombre_producto) VALUES (2, 5, '2024-04-30 02:04:13.000000', 'E');
INSERT INTO public.actividad (id, cantidad, fecha, nombre_producto) VALUES (3, 6, '2024-04-30 02:04:16.000000', 'I');
